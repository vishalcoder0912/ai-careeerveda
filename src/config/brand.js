...
export const BRAND_ICON_URL = "https://ik.imagekit.io/ojoijfoinsdnfoodsnf/careerveda/brand/logo.png";

// Favicon stays on the existing cvfavicon mark; change this too if you want the
// browser-tab icon to match the new logo.
const FAVICON_BASE = "https://ik.imagekit.io/ojoijfoinsdnfoodsnf/careerveda/brand/cvfavicon-039eb18e.jpg";
